...
public class EditUserInf extends Dialog {
	 ...
	 * @param style
	 */
	public EditUserInf(Shell parent, int style , String id) {
		super(parent, style);
		this.id=id;
		setText("修改用户信息");
	}
    ...
    protected void okPressed() {
        ...
        int rows = db.update(
            "UPDATE users SET username = '"+name+"', password = '" + password + "', phone = '" + phone + "'  WHERE user_id="+id+" "
        );
